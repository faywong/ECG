...
public class EcgClient extends Activity implements IECGMsgParser {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mDefaultSeries = (XYSeries) series.getSeries().get(XYPlotView.DEFAULT_SERIES_INDEX);
        /*
        ...
        testButton1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				for (int i = 1; i <= 10; i++) {
					XYSeries it = EcgClient.this.mDefaultSeries;
					if (null != it) {
						it.add(i * 1.0, Math.random() * 7000 + 11000);
						Log.d(TAG, "add data to series for the " + i +  "th time!");
					}
				}
			}
		});
	...
	private void startDiscoveryBluetoothDevices() {
		mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
